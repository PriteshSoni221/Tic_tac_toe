...
button3 = tk.Button(root, text=" ", command=lambda: play(button3), font=("times new roman", 22))
button3.place(relx=0.6, rely=0.3, relwidth=0.19, relheight=0.19)
button4 = tk.Button(root, text=" ", command=lambda: play(button4), font=("times new roman", 22))
button4.place(relx=0.2, rely=0.5, relwidth=0.19, relheight=0.19)
button5 = tk.Button(root, text=" ", command=lambda: play(button5), font=("times new roman", 22))
button5.place(relx=0.4, rely=0.5, relwidth=0.19, relheight=0.19)
button6 = tk.Button(root, text=" ", command=lambda: play(button6), font=("times new roman", 22))
button6.place(relx=0.6, rely=0.5, relwidth=0.19, relheight=0.19)
button7 = tk.Button(root, text=" ", command=lambda: play(button7), font=("times new roman", 22))
button7.place(relx=0.2, rely=0.7, relwidth=0.19, relheight=0.19)
button8 = tk.Button(root, text=" ", command=lambda: play(button8), font=("times new roman", 22))
